  ...
  return (
    <div className={Styles.wrapper}>
      <div className={Styles.section}>
        ...
        <p>
          Welcome to <strong>PushEat!</strong> This Privacy Policy explains how
          we collect, use, disclose, and protect your personal information when
          you use our Platform and Services. By accessing or using PushEat, you
      ...
      <div className={Styles.section}>
        ...
        <ul>
          ...
          <li>To enforce our Terms and Conditions and Community Guidelines.</li>
          <li>
      ...
      <div className={Styles.section}>
        ...
        <ul>
          <li>
            <strong>With Chefs and Users:</strong> To facilitate food deals, we
            share necessary information (e.g., delivery details) between chefs
            and users.
          </li>
          <li>
          ...
          <li>
            <strong>For Legal Reasons:</strong> To comply with laws, respond to
            legal requests, or protect our rights and safety.
          </li>
          <li>
      ...
      <div className={Styles.section}>
        ...
        <ul>
          ...
          <li>
            Chef-specific information (e.g., identity documents) is retained for
            verification and compliance purposes.
          </li>
          <li>
            User-generated content may be retained for archival purposes unless
            you delete it.
          </li>
        </ul>
      </div>
      ...
      <div className={Styles.section}>
        ...
        <ul>
          ...
          <li>Access controls to limit internal access to your information.</li>
        </ul>
        <p>
          <em>
      ...
      <div className={Styles.section}>
        ...
        <p>
          If we transfer your information outside Nigeria, we will ensure it is
          protected by appropriate safeguards, such as data transfer agreements
          or certifications.
        </p>
      </div>
      ...
      <div className={Styles.section}>
        ...
        <p>
          ...
          material changes, we will notify you through the Platform or by email.
          Your continued use of Pusheat after the changes take effect
