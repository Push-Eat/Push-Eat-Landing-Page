    ...
    <div className={styles.container}>
      ...
      <section>
        ...
        <p>
          ...
          of the Platform, including our related websites, services,
          applications, products, and content (collectively, the “Services”). By
      ...
      <section>
        ...
        <p>
          ...
          on the Platform or through other reasonable means. Your continued use
          of the Services after the changes take effect constitutes your
      ...
      <section>
        ...
        <p>
          ...
          during registration and to keep your account information current. You
        ...
        <p>
          ...
          deletion, your account and all associated content will be permanently
          removed from the Platform. You will not be able to reactivate your
          account or retrieve any content after deletion.
        </p>
        ...
        <ul className={styles.list}>
          ...
          <li>
            In our sole discretion, we determine that your account poses a risk
      ...
      <section>
        ...
        <ul className={styles.list}>
          ...
          <li>
            Upload or transmit viruses, malware, or any other harmful material.
          </li>
        </ul>
      </section>
      ...
      <section>
        ...
        <p>
          ...
          materials on the Platform (“PushEat Content”) are owned by or licensed
          to PushEat. You may not use, reproduce, or distribute PushEat Content
          without our prior written consent.
        </p>

        <h3 className={styles.subheading}>User Content</h3>
        <p>
          By posting content on PushEat, including food deals, videos, and other
          materials (“User Content”), you grant us a{" "}
          <strong>
            non-exclusive, royalty-free, worldwide, perpetual, and transferable
            license
          </strong>{" "}
          to use, reproduce, modify, adapt, distribute, and display your User
          Content for any purpose, including commercial purposes, to improve our
          Services, and to increase our goodwill and value. This license
